...
function View() {
    ...
    return (
        ...
        {/* Title */}
        <div className="title-container border-b rounded-t-xl text-center font-extrabold text-2xl sm:text-xl bg-[#DE92D0] p-1 relative flex justify-between items-center gap-10">
        ...
        {/* Footer Section */}
        <div className="footer-container  border-t rounded-b-xl flex justify-between sm:justify-center items-center bg-[#DE92D0] p-4">
