...
function View() {
    ...
    return (
        ...
        <div className='p-3'>    
        <div className="container border rounded-xl custom-shadow-view-box mx-auto overflow-hidden shadow-lg flex flex-col w-4/5 sm:w-3/5 md:w-2/5 min-h-[350px] sm:min-h-[300px] max-h-[90vh] my-8 relative">
    ...
    {/*    */}
        ...
        {/* Footer Section */}
        <div className="flex-[1] footer-container border-t rounded-b-xl flex justify-between sm:justify-center items-center bg-[#DE92D0] p-4">
