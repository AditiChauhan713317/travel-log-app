...
function View() {
    ...
    return (
        ...
        <div className="container custom-shadow-view-box mx-auto border rounded-xl overflow-hidden shadow-lg flex flex-col w-4/5 sm:w-3/5 md:w-2/5 min-h-[350px] sm:min-h-[300px] max-h-[90vh] mt-8 relative">
        {/* Close Button */}
        <i onClick={on_Close} className="close-btn fa-solid fa-xmark text-black absolute top-2 right-2 p-2 cursor-pointer"></i>
    
        {/* Title */}
        <div className="title-container flex-[1] border-b rounded-t-xl text-center font-extrabold text-2xl sm:text-xl bg-[#DE92D0] p-3">
            {cleaner_title}
        </div>
    
        {/* Main Content */}
        <div className="content-container flex-[10] p-4 text-justify bg-white relative overflow-hidden">
        ...
        {/* Footer Section */}
        <div className="footer-container flex-[1] border-t rounded-b-xl flex justify-between sm:justify-center items-center bg-[#DE92D0] p-4">
            <p className="footer-text text-md sm:text-sm">{"Generated by AI ;)"}</p>
            <div className="action-buttons absolute right-0 flex flex-col sm:flex-row items-center gap-3 p-4">
